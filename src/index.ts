...
import adminBilling from './api/adminBilling';
import { stripeWebhookRouter } from './api/stripeWebhook';
import adminPlans from './api/adminPlans';
...
app.get('/widget.js', (req, res) => {
  ...
  var version = '';
  try { version = (req.query && (req.query as any).v) ? String((req.query as any).v) : ''; } catch {}
  if (version) {
